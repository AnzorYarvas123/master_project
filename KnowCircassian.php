		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-4 p-b-40">
					...
					<div class="blog-item">
						<div class="hov-img0">
						<iframe width="360" height="315" src="https://www.youtube.com/embed/TZHMyVNnU5o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
						</div>
						...
						<div class="p-t-15">
							<div class="stext-107 flex-w p-b-14">
								<span class="m-r-3">
									<span class="cl4 text-light">
									<a href="./article1.php"><h4 class="cl4 text-light">Who are the CIRCASSIANS</br>in Arabic</h4></a>
								</span>
							</div>
				...
				<div class="col-sm-6 col-md-4 p-b-40">
					<div class="blog-item">
						<div class="hov-img0">
                        <iframe width="360" height="315" src="https://www.youtube.com/embed/ehjtgFQjwQc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
						</div>
						...
						<div class="p-t-15">
							<div class="stext-107 flex-w p-b-14">
								<span class="m-r-3">
									<span class="cl4">
									<a href="./article2.php"><h4 class="cl4 text-light">CIRCASSIAN MUSIC</h4></a>
									</span>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-4 p-b-40">
					<div class="blog-item">
						<div class="hov-img0">
							<a href="./article5.php">
								<img src="./main_image/article8.png" alt="IMG-BLOG">
							</a>
						</div>
