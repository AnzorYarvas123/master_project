...
<body  style="background-color: #5a5a5a20">
	...
	<div  style="background-color: #5a5a5a20" >
		<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg" >
			...
			<span class="mtext-80 cl4 text-white-50">
				Shopping Cart
			</span>
		</div>
	</div>
	...
	<!-- Shoping Cart -->
	<form class="bg0 p-t-75 p-b-85" style="background-color: #5a5a5a20">
		<div class="container">
			<div class="row">
				<?php if ($cartRows > 0) : ?>
					<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
						<div class="m-l-25 m-r--38 m-lr-0-xl">
							<div class="wrap-table-shopping-cart ">
								<table class="table-shopping-cart table-striped table-hover table-sm">
									<tr class="table_head ">
										<th class="column-1 text-white-50">Product</th>
										
										<th class="column-2 text-white-50"></th>
										<th class="column-3 text-white-50">Price</th>
										<th class="column-4 text-white-50 pr-5">Quantity</th>
										<!-- <th class="column-5 text-white-50">Total</th> -->
									...
									<?php foreach ($userCart as $item) : ?>
										...
										<tr class="table_row">
											...
											<td class="column-2 text-white-50"><?= $item['name']; ?></td>
											<td class="column-3 text-white-50">
											...
											<td class="column-4">
												<div class=" flex-w m-l-auto m-r-0">
													...
													<input class="mtext-104 cl3 txt-center num-product m-l-50" type="number" id="num-product<?= $item['product_id'] ?>" value="<?= $item['quantity']; ?>"style="background-color: #d8d8d8" >
					...
					<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
						<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
							<h4 class="mtext-109 cl2 p-b-30 text-secondary">
								Cart Total Price
							</h4>

							<div class="flex-w flex-t p-t-27 p-b-33 ">
								<div class="size-208">
									<span class="mtext-101 cl2 text-secondary">
										Total:
									</span>
								</div>

								<div class="size-209 p-t-1">
									<span class="mtext-110 cl2 text-secondary">
										<?= $total ?> JOD
									</span>
								</div>
							</div>
							<a href="./checkout.php" class="flex-c-m stext-101 text-light cl0 size-116 bg3 bor14 bg-secondary p-lr-15 trans-04 pointer">
								Checkout
